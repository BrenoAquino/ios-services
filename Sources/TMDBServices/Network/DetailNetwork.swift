...
public class DetailBusiness {
    ...
    public func getDetail(task: DispatchGroup? = nil, id: Int, callback: ((Result<Movie, NSError>) -> Void)? = nil) {
        task?.enter()
    ...
    public func getKeywords(task: DispatchGroup? = nil, id: Int, callback: ((Result<[Keyword], NSError>) -> Void)? = nil) {
        task?.enter()
    ...
    public func getRecommendations(task: DispatchGroup? = nil, id: Int, callback: ((Result<[Movie], NSError>) -> Void)? = nil) {
        task?.enter()
